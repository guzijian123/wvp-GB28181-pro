<template>
  <div id="deviceEdit" v-loading="isLoging">
    <el-dialog title="设备编辑" width="40%" top="2rem" :close-on-click-modal="false" :visible.sync="showDialog"
      ...
      <div id="shared" style="margin-top: 1rem;margin-right: 100px;">
        <el-form ref="form" :rules="rules" :model="form" label-width="200px">
          ...
          <el-form-item v-if="this.isEdit" label="报警订阅" title="0为取消订阅" prop="subscribeCycleForAlarm">
            <el-input v-model="form.subscribeCycleForAlarm" clearable></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onSubmit: function () {
      ...
      this.form.subscribeCycleForAlarm = this.form.subscribeCycleForAlarm || 0
      this.$axios({
        method: 'post',
